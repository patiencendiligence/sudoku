...
3. Click a blank space and enter a number from 1 to 9
4. Keyboard or number pad available
5. Level up when completed!


# Quick Notes (Sudoku Game)

몰래 즐길 수 있는 스도쿠 게임 브라우저 확장프로그램입니다.
